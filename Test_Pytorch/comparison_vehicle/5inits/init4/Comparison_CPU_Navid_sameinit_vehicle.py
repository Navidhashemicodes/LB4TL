...
weights_file_path = FOLDERNAME + '/Test_Pytorch/comparison_vehicle/5inits/init4/weights.mat'
biases_file_path = FOLDERNAME + '/Test_Pytorch/comparison_vehicle/5inits/init4/biases.mat'
...
export2matlab("RP_reviewer_Controller_init4_LB4TL",controller_net.cpu())
