...
initweights_file_path = FOLDERNAME + '/Test_Pytorch/comparison_vehicle/5inits/init1/init_weights.mat'
initbiases_file_path = FOLDERNAME + '/Test_Pytorch/comparison_vehicle/5inits/init1/init_biases.mat'
...
weights_file_path = FOLDERNAME + '/Test_Pytorch/comparison_vehicle/5inits/init1/weights.mat'
biases_file_path = FOLDERNAME + '/Test_Pytorch/comparison_vehicle/5inits/init1/biases.mat'

r_network = RNetwork(weights_file_path, biases_file_path)


weights_file_path_acc = FOLDERNAME + '/Test_Pytorch/comparison_vehicle/5inits/init1/weights_acc.mat'
biases_file_path_acc = FOLDERNAME + '/Test_Pytorch/comparison_vehicle/5inits/init1/biases_acc.mat'
...
export2matlab("RP_reviewer_Controller_init1_LB4TL",controller_net.cpu())
