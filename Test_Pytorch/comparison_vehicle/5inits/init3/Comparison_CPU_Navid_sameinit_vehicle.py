...
weights_file_path = FOLDERNAME + '/Test_Pytorch/comparison_vehicle/5inits/init3/weights.mat'
biases_file_path = FOLDERNAME + '/Test_Pytorch/comparison_vehicle/5inits/init3/biases.mat'
...
export2matlab("RP_reviewer_Controller_init3_LB4TL",controller_net.cpu())
