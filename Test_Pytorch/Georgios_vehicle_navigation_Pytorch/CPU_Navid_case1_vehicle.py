...
# RP_dir = ' ... < directory of ADHS_RP  folder> ... '  see the following example:
RP_dir = str (pathlib.Path().resolve()) #'C:/Users/navid/Documents/MATLAB/MATLAB_prev/Toyota/ADHS_RP'
RP_dir = RP_dir + '/../..'
sys.path.append( RP_dir + '/Test_Pytorch' )
...
initweights_file_path = RP_dir + '/Test_Pytorch/Georgios_vehicle_navigation_Pytorch/init_weights.mat'
initbiases_file_path = RP_dir + '/Test_Pytorch/Georgios_vehicle_navigation_Pytorch/init_biases.mat'
...
weights_file_path = RP_dir + '/Test_Pytorch/Georgios_vehicle_navigation_Pytorch/weights.mat'
biases_file_path = RP_dir + '/Test_Pytorch/Georgios_vehicle_navigation_Pytorch/biases.mat'

r_network = RNetwork(weights_file_path, biases_file_path)


weights_file_path_acc = RP_dir + '/Test_Pytorch/Georgios_vehicle_navigation_Pytorch/weights_acc.mat'
biases_file_path_acc = RP_dir + '/Test_Pytorch/Georgios_vehicle_navigation_Pytorch/biases_acc.mat'
...
export2matlab("RP_reviewer_Controller_LB4TL_case1",controller_net.cpu())
savemat('traininfo.mat', {'Runtime_train': elapsed_time})